...
#makes a child class to inherit the properties of ObjectCounter
class CertaibObjectCounter(ObjectCounter):
    def __init__(self):
        super().__init__()
        self.object_list={}
    
    def in_objects(self):
        print("CertaibObjectCounter--in_objects")
